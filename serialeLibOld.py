...
unitPattern = "([pnumk]?V|[pnumk]?s|[hlct]?g|b|d|a)"
...
def genStringsForFile(s,m,n,hg,lg,impDist=None,holdDelay=None,shaperTConst=None):
    fStr = f"{s}_"
    lStr = ""
    mErrPres = False
    nErrPres = False
...
def genFileNameList(suffixName,mvpar,nspar,gpar,impDistpar,holdDelaypar,shapTpar):
    fileNames = []
    paramStringList = []
    hgpar = []
    lgpar = []
